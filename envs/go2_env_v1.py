"""FROZEN v1 environment - kept verbatim for before/after comparison.

This is the original Go2Env exactly as it stood before the v2 rewrite. It is
referenced by docs/14-debugging-log.md and by the ablation experiments. It
contains known bugs (documented in that chapter); do not fix them here, that is
the entire point of keeping the file.

The class is renamed Go2EnvV1 so both versions can be imported side by side.
"""
